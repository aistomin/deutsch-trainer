...
public class StAsgml3 extends AbstractRoutine<String> {
     ...
     */
    public static final Parameter<String> NPREFIX = Internal.createParameter("nprefix", SQLDataType.CLOB.defaultValue(DSL.field("'gml'::text", SQLDataType.CLOB)), true, false);

    /**
     * The parameter <code>public.st_asgml.id</code>.
     */
    public static final Parameter<String> ID = Internal.createParameter("id", SQLDataType.CLOB.defaultValue(DSL.field("''::text", SQLDataType.CLOB)), true, false);
