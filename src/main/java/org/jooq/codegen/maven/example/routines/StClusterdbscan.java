...
public class StClusterdbscan extends AbstractRoutine<Integer> {
     ...
     */
    public static final Parameter<Double> EPS = Internal.createParameter("eps", SQLDataType.DOUBLE, false, false);

    /**
     * The parameter <code>public.st_clusterdbscan.minpoints</code>.
     */
    public static final Parameter<Integer> MINPOINTS = Internal.createParameter("minpoints", SQLDataType.INTEGER, false, false);
