...
public class StFilterbym extends AbstractRoutine<Object> {
     ...
     */
    public static final Parameter<Double> _3 = Internal.createParameter("_3", SQLDataType.DOUBLE.defaultValue(DSL.field("NULL::double precision", SQLDataType.DOUBLE)), true, true);

    /**
     * The parameter <code>public.st_filterbym._4</code>.
     */
    public static final Parameter<Boolean> _4 = Internal.createParameter("_4", SQLDataType.BOOLEAN.defaultValue(DSL.field("false", SQLDataType.BOOLEAN)), true, true);

    /**
     * Create a new routine call instance
     */
    public StFilterbym() {
        super("st_filterbym", Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("\"public\".\"geometry\""));
