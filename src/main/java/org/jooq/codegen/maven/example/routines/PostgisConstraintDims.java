...
public class PostgisConstraintDims extends AbstractRoutine<Integer> {
     ...
     */
    public static final Parameter<String> GEOMSCHEMA = Internal.createParameter("geomschema", SQLDataType.CLOB, false, false);

    /**
     * The parameter <code>public.postgis_constraint_dims.geomtable</code>.
     */
    public static final Parameter<String> GEOMTABLE = Internal.createParameter("geomtable", SQLDataType.CLOB, false, false);

    /**
     * The parameter <code>public.postgis_constraint_dims.geomcolumn</code>.
     */
    public static final Parameter<String> GEOMCOLUMN = Internal.createParameter("geomcolumn", SQLDataType.CLOB, false, false);
