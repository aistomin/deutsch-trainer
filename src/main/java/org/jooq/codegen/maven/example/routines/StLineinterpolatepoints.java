...
public class StLineinterpolatepoints extends AbstractRoutine<Object> {
     ...
     */
    public static final Parameter<Boolean> REPEAT = Internal.createParameter("repeat", SQLDataType.BOOLEAN.defaultValue(DSL.field("true", SQLDataType.BOOLEAN)), true, false);

    /**
     * Create a new routine call instance
     */
    public StLineinterpolatepoints() {
        super("st_lineinterpolatepoints", Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("\"public\".\"geometry\""));
