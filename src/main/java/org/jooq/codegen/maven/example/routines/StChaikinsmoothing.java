...
public class StChaikinsmoothing extends AbstractRoutine<Object> {
     ...
     */
    public static final Parameter<Integer> _2 = Internal.createParameter("_2", SQLDataType.INTEGER.defaultValue(DSL.field("1", SQLDataType.INTEGER)), true, true);

    /**
     * The parameter <code>public.st_chaikinsmoothing._3</code>.
     */
    public static final Parameter<Boolean> _3 = Internal.createParameter("_3", SQLDataType.BOOLEAN.defaultValue(DSL.field("false", SQLDataType.BOOLEAN)), true, true);

    /**
     * Create a new routine call instance
     */
    public StChaikinsmoothing() {
        super("st_chaikinsmoothing", Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("\"public\".\"geometry\""));
