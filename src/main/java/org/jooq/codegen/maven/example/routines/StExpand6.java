...
public class StExpand6 extends AbstractRoutine<Object> {
     ...
     */
    public static final Parameter<Double> DM = Internal.createParameter("dm", SQLDataType.DOUBLE.defaultValue(DSL.field("0", SQLDataType.DOUBLE)), true, false);

    /**
     * Create a new routine call instance
     */
    public StExpand6() {
        super("st_expand", Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("\"public\".\"geometry\""));
