...
public class StAngle1 extends AbstractRoutine<Double> {
     ...
     */
    @Deprecated
    public static final Parameter<Object> PT4 = Internal.createParameter("pt4", org.jooq.impl.DefaultDataType.getDefaultDataType("\"public\".\"geometry\"").defaultValue(DSL.field("'0101000000000000000000F87F000000000000F87F'::geometry", SQLDataType.OTHER)), true, false);
